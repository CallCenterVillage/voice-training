...
export const seResources = [
  ...
  { name: "CISA — Scattered Spider Advisory (AA23-320A)", url: "https://www.cisa.gov/news-events/cybersecurity-advisories/aa23-320a", desc: "Joint CISA/FBI advisory on Scattered Spider, whose signature move is phoning the IT help desk to obtain an MFA reset on a privileged account", archiveUrl: "https://web.archive.org/web/20260625040416/https://www.cisa.gov/news-events/cybersecurity-advisories/aa23-320a" },
  { name: "Google Threat Intelligence — Salesforce Vishing (UNC6040)", url: "https://cloud.google.com/blog/topics/threat-intelligence/voice-phishing-data-extortion", desc: "Vishing campaign in which callers talked employees into authorizing a malicious connected app — access that never re-prompts for MFA", archiveUrl: "https://web.archive.org/web/20260716001826/https://cloud.google.com/blog/topics/threat-intelligence/voice-phishing-data-extortion" },
  { name: "Google Threat Intelligence — BlackFile (UNC6671)", url: "https://cloud.google.com/blog/topics/threat-intelligence/blackfile-vishing-extortion-operation", desc: "Vishing operation running a live adversary-in-the-middle relay during the call, then registering the attacker's own device" },
  { name: "Proofpoint — TOAD / Callback Phishing", url: "https://www.proofpoint.com/us/resources/threat-reports/human-factor-social-engineering", desc: "Telephone-Oriented Attack Delivery, where the email is deliberately clean so it survives filtering and the payload is the phone call itself", archiveUrl: "https://web.archive.org/web/20260704122630/https://www.proofpoint.com/us/resources/threat-reports/human-factor-social-engineering" },
  { name: "FBI IC3 — 2025 Internet Crime Report", url: "https://www.ic3.gov/AnnualReport/Reports/2025_IC3Report.pdf", desc: "Record $20.9B in reported losses, including the first dedicated AI section (~$893M) covering voice cloning in fraud", archiveUrl: "https://web.archive.org/web/20260715182556/https://www.ic3.gov/AnnualReport/Reports/2025_IC3Report.pdf" },
  { name: "FTC — Consumer Sentinel Data Book", url: "https://www.ftc.gov/system/files/ftc_gov/pdf/csn-annual-data-book-2024.pdf", desc: "FTC fraud data by contact method — the telephone carries the highest median loss per victim (about $1,500)", archiveUrl: "https://web.archive.org/web/20260624184934/https://www.ftc.gov/system/files/ftc_gov/pdf/csn-annual-data-book-2024.pdf" },
  { name: "FTC — Imposter Scams 2025", url: "https://www.ftc.gov/news-events/news/press-releases/2026/06/ftc-data-show-people-reported-losing-3-point-5-billion-imposter-scams-2025", desc: "$3.5B lost to imposter scams in 2025 — the top reported fraud category for the fifth consecutive year", archiveUrl: "https://web.archive.org/web/20260623020651/https://www.ftc.gov/news-events/news/press-releases/2026/06/ftc-data-show-people-reported-losing-3-point-5-billion-imposter-scams-2025" },
