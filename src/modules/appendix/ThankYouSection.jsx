  ...
  <div>
    ...
    <div style={{ display: "grid", gap: 24 }}>
      <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 12, padding: "32px 32px" }}>
        <div id="the-conferences" style={{ fontSize: 16, fontWeight: 700, color: C.text, marginBottom: 8, scrollMarginTop: 120 }}>The Conferences</div>
      ...
      <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 12, padding: "32px 32px" }}>
        <div id="the-people" style={{ fontSize: 16, fontWeight: 700, color: C.text, marginBottom: 8, scrollMarginTop: 120 }}>The People</div>
        <p style={{ color: C.muted, fontSize: 14, lineHeight: 1.8, margin: 0 }}>
      ...
      <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 12, padding: "32px 32px" }}>
        <div id="the-customers" style={{ fontSize: 16, fontWeight: 700, color: C.text, marginBottom: 8, scrollMarginTop: 120 }}>The Customers</div>
        <p style={{ color: C.muted, fontSize: 14, lineHeight: 1.8, margin: 0 }}>
      ...
      <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 12, padding: "32px 32px" }}>
        <div id="the-sponsors" style={{ fontSize: 16, fontWeight: 700, color: C.text, marginBottom: 8, scrollMarginTop: 120 }}>The Sponsors</div>
        <p style={{ color: C.muted, fontSize: 14, lineHeight: 1.8, margin: 0 }}>
