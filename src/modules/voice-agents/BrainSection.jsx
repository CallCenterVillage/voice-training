...
import { SystemPromptExplainer } from "./_helpers";
...
export default function BrainSection() {
  ...
  <div>
    ...
    <h2 id="local-llms" style={{ fontSize: 18, fontWeight: 700, color: C.text, marginBottom: 4, scrollMarginTop: 120 }}>llama.cpp</h2>
    <p style={{ color: C.muted, fontSize: 14, lineHeight: 1.7, marginBottom: 12 }}>Run language models entirely on your machine. No API keys, no data leaving your network. The quality and speed of local models will depend on how powerful your machine is — more RAM and a dedicated GPU allow you to run larger, more capable models.</p>
    ...
    <h2 id="example-system-prompt" style={{ fontSize: 18, fontWeight: 700, color: C.text, marginBottom: 4, scrollMarginTop: 120 }}>Example: Voice Agent System Prompt</h2>
    <p style={{ color: C.muted, fontSize: 14, lineHeight: 1.7, marginBottom: 12 }}>Voice agent system prompts need special considerations compared to text chatbots. Hover over each section to learn why it matters.</p>
    <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 12, padding: 20, marginBottom: 12 }}>
    ...
    <SectionDivider />
    <h2 id="streaming-latency" style={{ fontSize: 18, fontWeight: 700, color: C.text, marginBottom: 4, scrollMarginTop: 120 }}>Streaming: The Key to Low Latency</h2>
    ...
    <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 12, padding: 20, marginBottom: 12 }}>
      ...
      <div style={{ fontSize: 16, fontWeight: 700, color: C.text, marginTop: 64 }}>Give It a Try</div>
      <p>These examples chain an LLM response directly into TTS. Notice how you have to wait for the full LLM generation to complete before you hear anything:</p>
