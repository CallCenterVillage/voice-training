import { C, CodeBlock, Icon } from "../../components";
...
export default function BuildingSection() {
  ...
  <div>
    ...
    <div id="fully-local-agent" style={{ scrollMarginTop: 120 }}>
    ...
    <SectionDivider />
    <div id="cloud-hybrid-livekit" style={{ scrollMarginTop: 120 }}>
    ...
    <SectionDivider />
    <div id="architecture-decision-matrix" style={{ scrollMarginTop: 120 }}>
