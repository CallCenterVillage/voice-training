...
const CallCenterSection = () => (
  <div>
    ...
    <div id="ai-to-human-handoff" style={{ scrollMarginTop: 120 }}><ScenarioSim
    ...
    <div id="multi-channel-attack" style={{ scrollMarginTop: 120 }}><ScenarioSim
    ...
    /></div>
    <SectionDivider />
    <div id="escalation-ladder" style={{ scrollMarginTop: 120 }}><StaticCard title={<><Icon name="chart-bar" size={16} style={{ display: "inline-block", verticalAlign: "middle", marginRight: 6 }} />Attack Pattern: The Escalation Ladder</>}>
